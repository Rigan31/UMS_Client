...
const ApplyScholarship= () => {
    ...
    const routeChangeToProfile = () =>{ 
        const url = `../single_apply_scholarship?name=${data.scholarship_name}&student_id=${data.student_id}&session=${data.session_id}`;
        navigate(url);
    }
                    ...
                    <Form onSubmit={(e)=> submit(e)}>
                        ...
                        <Row className="mb-3">
                            <Form.Group as={Col} controlId="formGridAddress1">
                                ...
                                <Form.Control type="text" id="scholarship_name" defaultValue={data.scholarship_name} onChange={(e)=> handle(e)} disabled/>
                            </Form.Group>
                        </Row>
